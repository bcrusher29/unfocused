...
if action == '1clickcollections':
    from resources.lib.indexers import lists
    lists.indexer().root_1clickcollections()

if action == 'sports':
    from resources.lib.indexers import lists
    lists.indexer().root_sports()
...
if action == 'kids':
    from resources.lib.indexers import lists
    lists.indexer().root_kids()

if action == 'kids1':
    from resources.lib.indexers import lists
    lists.indexer().root_kids1()

if action == 'kids_dis1':
    from resources.lib.indexers import lists
    lists.indexer().root_kids_dis1()

if action == 'kids_random':
    from resources.lib.indexers import lists
    lists.indexer().root_kids_random()  

if action == 'iptv_usa':
    from resources.lib.indexers import lists
    lists.indexer().root_iptv_usa()

if action == 'iptv_uk':
    from resources.lib.indexers import lists
    lists.indexer().root_iptv_uk()

if action == 'iptv_world':
    from resources.lib.indexers import lists
    lists.indexer().root_iptv_world()

if action == 'iptv_cctv':
    from resources.lib.indexers import lists
    lists.indexer().root_iptv_cctv()

if action == 'iptv_test':
    from resources.lib.indexers import lists
    lists.indexer().root_iptv_test()

elif action == 'sportsNavigator':
