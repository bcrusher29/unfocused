...
class movies:
    def __init__(self):
        ...
        self.ABoneCrusheronElmStreet_link = 'http://www.imdb.com/list/ls009545233?sort=release_date,asc&st_dt=&mode=detail&page=1'
    ...
    def years(self):
        ...
        for i in range(int(year)-0, 1930, -1): self.list.append({'name': str(i), 'url': self.year_link % (str(i), str(i)), 'image': 'fre.png', 'action': 'movies'})
        self.addDirectory(self.list)
        return self.list
