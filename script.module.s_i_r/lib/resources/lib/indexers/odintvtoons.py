...
class tvshows:
    ...
    def animecertifications(self):
        ...
        for i in certificates: self.list.append({'name': str(i), 'url': self.animecertification_link % str(i).replace('-', '_').lower(), 'image': 'js.png', 'action': 'tvshows'})
    ...
    def animeyears(self):
        ...
        for i in range(int(year)-0, 1950, -1): self.list.append({'name': str(i), 'url': self.animeyear_link % (str(i), str(i)), 'image': 'js.png', 'action': 'tvshows'})
        self.addDirectory(self.list)
        return self.list		
    ...
    def years(self):
        ...
        for i in range(int(year)-0, 1950, -1): self.list.append({'name': str(i), 'url': self.year_link % (str(i), str(i)), 'image': 'js.png', 'action': 'tvshows'})
        self.addDirectory(self.list)
        return self.list
