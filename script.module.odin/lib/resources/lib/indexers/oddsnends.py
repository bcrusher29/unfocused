...
#       self.addDirectoryItem(32574, 'metalNavigator', 'Rock.png', 'decepticons.png')
    ...
    def Clts(self, lite=False):
        ...
        self.addDirectoryItem('canada loves tv shows', 'tvshows2&url=tmdbcanada', 'decepticons.png', 'decepticons.png')
    ...
    def at(self, lite=False):
        ...
        self.addDirectoryItem('anime tv', 'tvshows2&url=tmdbanime', 'decepticons.png', 'decepticons.png')
    ...
    def Tl(self, lite=False):
        ...
        self.addDirectoryItem('Elvis Tv Shows', 'tvshows2&url=tmdbelvis', 'classics.png', 'DefaultRecentlyAddedMovies.png')
        ...
        self.addDirectoryItem('Clint Eastwood tv ', 'tvshows2&url=tmdbeastwood', 'decepticons.png', 'decepticons.png')
        self.addDirectoryItem('John Wayne ', 'movies2&url=tmdbjwayne', 'decepticons.png', 'decepticons.png')
        self.addDirectoryItem('John Wayne tv shows', 'tvshows2&url=tmdbjwayne', 'decepticons.png', 'decepticons.png')
        self.endDirectory()
    ...
    def users(self, lite=False):
        ...
        self.addDirectoryItem('Sci fi tv shows', 'tvshows2&url=tmdbScfinew', 'Users requests.png', 'decepticons.png')
        self.addDirectoryItem('Sci fi movies', 'movies2&url=tmdbScfinew', 'Users requests.png', 'decepticons.png')
        self.addDirectoryItem('User Requested Tv Shows Comedy', 'tvshows2&url=tmdbcom1', 'Users requests.png', 'decepticons.png')
        ...
        self.addDirectoryItem('Super Heroes tv shows ', 'tvshows2&url=tmdbsuper', 'Users requests.png', 'decepticons.png')
        self.endDirectory()

    def Paratv(self, lite=False):
        self.addDirectoryItem('[COLOR yellow]users requets accepted[/COLOR]', '', 'decepticons.png', 'decepticons.png')
        self.addDirectoryItem(' paranormal tv', 'tvshows2&url=tmdbparanormal', 'decepticons.png', 'decepticons.png')
    ...
    def koc(self, lite=False):
        ...
        self.addDirectoryItem('Red fox tv shows', 'tvshows2&url=tmdbfox', 'decepticons.png', 'decepticons.png')
        ...
        self.addDirectoryItem('laurel and hardy tv shows', 'tvshows2&url=tmdblaurel', 'decepticons.png', 'decepticons.png')

        self.endDirectory()

    def qoc(self, lite=False):
        self.addDirectoryItem('Lucy Ball', 'tvshows22&url=tmdbBall', 'decepticons.png', 'decepticons.png')
    ...
    def darktv(self, lite=False):
        ...
        self.addDirectoryItem('dark tv tv shows', 'tvshows2&url=tmdbdarktv', 'decepticons.png', 'decepticons.png')
        self.addDirectoryItem('firestick movies', 'movies2&url=tmdbfirestick', 'decepticons.png', 'decepticons.png')
        self.addDirectoryItem('firestick tv shows', 'tvshows2&url=tmdbfirestick', 'decepticons.png', 'decepticons.png')
    ...
    def gifts(self, lite=False):
        ...
        self.addDirectoryItem('heavenly gifts tv shows', 'tvshows2&url=tmdbgifts', 'gifts1.png', 'decepticons.png')
        self.addDirectoryItem('Leons  movies', 'movies2&url=tmdbleon', 'gifts1.png', 'decepticons.png')
        self.addDirectoryItem('Leons tv shows', 'tvshows2&url=tmdbleon', 'gifts1.png', 'decepticons.png')
        self.endDirectory()
      
    def tools(self):
        self.addDirectoryItem('[B]URL RESOLVER[/B]: Settings', 'lulzfamresolversettings', 'decepticons.png', 'DefaultAddonProgram.png')
    ...
    def views(self):
        try:
            ...
            items = [ (control.lang(32001).encode('utf-8'), 'movies'), (control.lang(32002).encode('utf-8'), 'tvshows2'), (control.lang(32054).encode('utf-8'), 'seasons'), (control.lang(32038).encode('utf-8'), 'episodes') ]
