...
class indexer:
    ...
    def root(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/bcrusher29/unfocused/master/xmls/main.xml'
