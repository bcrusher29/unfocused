...
import urlparse
from bonecrusherscrapers.modules import control
from bonecrusherscrapers import providerSources, providerNames

params = dict(urlparse.parse_qsl(sys.argv[2].replace('?', '')))
mode = params.get('mode')

def ScraperChoice():
    from bonecrusherscrapers import providerSources
...
def ToggleProviderAll(enable):
    from bonecrusherscrapers import providerNames
...
def toggleAll(setting, open_id=None, sourceList=None):
    from bonecrusherscrapers import getAllHosters
...
if mode == "bonecrusherSettings":
    control.openSettings('0.0', 'script.module.bonecrusherscrapers')
