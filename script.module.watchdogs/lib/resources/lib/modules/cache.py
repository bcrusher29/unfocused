...
def _find_cache_version():
    ...
    try:
        ...
        import xbmc
        print 'Watchdogs Addon Data Path Does not Exist. Creating Folder....'
        ad_folder = xbmc.translatePath('special://home/userdata/addon_data/plugin.video.watchdogs')
    ...
    try:
        curVersion = control.addon('script.module.watchdogs').getAddonInfo('version')
