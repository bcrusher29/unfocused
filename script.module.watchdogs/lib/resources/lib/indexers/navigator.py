...
class navigator:
    ...
    def root(self):
        ...
        porn = True if control.setting('porn_pw') == 'perv' else False
        if porn == True:
            self.addDirectoryItem('[B][COLOR orange]Watchdogs Lists[/COLOR][/B]', 'lists', 'lists.png', 'DefaultMoviesShows.png')
            
        if self.getMenuEnabled('navi.monthlyspotlight') == True:
            self.addDirectoryItem('[B][COLOR blue]Monthly Spotlight[/COLOR][/B]', 'movies&url=spotlight', 'spotlight.png', 'DefaultRecentlyAddedMovies.png')
        
        if self.getMenuEnabled('navi.sports') == True:
            self.addDirectoryItem('Sports Area', 'sports', 'sports.png', 'sports.png')
        
        if self.getMenuEnabled('navi.iptv') == True:
            self.addDirectoryItem('IPTV Area', 'iptvNavigator', 'iptv.png', 'iptv.png')
        ...
        if self.getMenuEnabled('navi.kids') == True:
            self.addDirectoryItem('Kids Area', 'kidsNavigator', 'kids.png', 'kids.png')
        ...
        self.addDirectoryItem('Status', 'newsNavigator', 'help.png', 'DefaultAddonProgram.png')
...
#######################################################################
    def kids(self):
        self.addDirectoryItem('Kids Place', 'kidsplace', 'kids.png', 'kids.png')
        self.addDirectoryItem('Cartoons', 'tvshows&url=cartoons', 'cartoons.png', 'cartoons.png')
        self.addDirectoryItem('Nickelodeon', 'tvshows&url=nic', 'kids.png', 'kids.png')
        self.addDirectoryItem('Cartoon Network', 'tvshows&url=cn', 'kids.png', 'kids.png')
        self.addDirectoryItem('Disney', 'tvshows&url=dis', 'kids.png', 'kids.png')
        self.addDirectoryItem('Kids TV Shows', 'kids', 'kids.png', 'kids.png')
        self.addDirectoryItem('Random Kids', 'kids_random', 'kids.png', 'kids.png')
        
        self.endDirectory()

    def iptv(self):
        self.addDirectoryItem('USA Channels', 'iptv_usa', 'iptv.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('UK Channels', 'iptv_uk', 'iptv.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('WORLD Channels', 'iptv_world', 'iptv.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('CCTV', 'iptv_cctv', 'iptv.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem(32007, 'channels', 'channels.png', 'DefaultMovies.png')
        self.addDirectoryItem('Swift Streams', 'swiftNavigator', 'iptv.png', 'iptv.png')

        self.endDirectory()
   
    def movies(self, lite=False):
        self.addDirectoryItem('[B][COLORred]Watchdogs Favorites[/COLOR][/B]', 'movies&url=watchdogs', 'favs.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLORyellow]Sci-Fi Flicks[/COLOR][/B]', 'movies&url=scifi', 'scifi.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLORred]Horror Movies[/COLOR][/B]', 'movies&url=horror', 'horror.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLORblue]Western Movies[/COLOR][/B]', 'movies&url=western', 'westerns.png', 'DefaultRecentlyAddedMovies.png')
        self.addDirectoryItem('[B][COLORblue]Zombie Movies[/COLOR][/B]', 'movies&url=zombie', 'zombie.png', 'DefaultRecentlyAddedMovies.png')
        ...
        self.addDirectoryItem('4K UHD', '4k', '4k.png', '4k.png')
        self.addDirectoryItem('1 Click Movies (Real-Debrid May be Required)', '1click', '1click.png', '1click.png')
        self.addDirectoryItem('1 Click Collections', '1clicksets', '1click.png', '1click.png')
    ...
    def tvshows(self, lite=False):
        self.addDirectoryItem('[B][COLOR yellow]24/7 TV Shows[/COLOR][/B]', '247tv', 'tvshows.png', 'DefaultTVShows.png')
    ...
    def tools(self):
        ...
        self.addDirectoryItem(32044, 'openSettings&query=7.1', 'tools.png', 'DefaultAddonProgram.png')
