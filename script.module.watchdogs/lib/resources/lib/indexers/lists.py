...
#please dont share link
    ...
    def root_sports(self):
        try:
            regex.clear()
            url = '68747470733a2f2f7261772e67697468756275736572636f6e74656e742e636f6d2f7468653133636c6f776e732f7265736f75726365732f6d61737465722f74526d4b476a5462722f786d6c732f73706f7274732f73706f7274732e786d6c'.decode('hex')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_kids(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/Firegod36/apocalypse/master/kidmovies.xml'
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_iptv_usa(self):
        try:
            regex.clear()
            url = '68747470733a2f2f7261772e67697468756275736572636f6e74656e742e636f6d2f7468653133636c6f776e732f7265736f75726365732f6d61737465722f74526d4b476a5462722f786d6c732f697074762f5553412e6d3375'.decode('hex')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_iptv_uk(self):
        try:
            regex.clear()
            url = '68747470733a2f2f7261772e67697468756275736572636f6e74656e742e636f6d2f7468653133636c6f776e732f7265736f75726365732f6d61737465722f74526d4b476a5462722f786d6c732f697074762f756b2e6d3375'.decode('hex')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_iptv_world(self):
        try:
            regex.clear()
            url = '68747470733a2f2f7261772e67697468756275736572636f6e74656e742e636f6d2f7468653133636c6f776e732f7265736f75726365732f6d61737465722f74526d4b476a5462722f786d6c732f697074762f776f726c642e6d3375'.decode('hex')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_iptv_cctv(self):
        try:
            regex.clear()
            url = '68747470733a2f2f706173746562696e2e636f6d2f7261772f524879663033794b'.decode('hex')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_test(self):
        try:
            regex.clear()
            url = '68747470733a2f2f7261772e67697468756275736572636f6e74656e742e636f6d2f7468653133636c6f776e732f7265736f75726365732f6d61737465722f74526d4b476a5462722f786d6c732f706f726e2f63706f726e2e786d6c'.decode('hex')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_247movies(self):
        try:
            regex.clear()
            url = '68747470733a2f2f7261772e67697468756275736572636f6e74656e742e636f6d2f7468653133636c6f776e732f7265736f75726365732f6d61737465722f74526d4b476a5462722f786d6c732f3234376d6f766965732e786d6c'.decode('hex')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_247tv(self):
        try:
            regex.clear()
            url = '68747470733a2f2f7261772e67697468756275736572636f6e74656e742e636f6d2f7468653133636c6f776e732f7265736f75726365732f6d61737465722f74526d4b476a5462722f786d6c732f32343773686f77732e786d6c'.decode('hex')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_4k(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/Firegod36/apocalypse/master/4k.xml'
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_1click(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/Firegod36/apocalypse/master/oneclick.xml'
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_1clicksets(self):
        try:
            regex.clear()
            url = '68747470733a2f2f706173746562696e2e636f6d2f7261772f3275723654775864'.decode('hex')
            self.list = self.watchdogs_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def addSearch(self, url):
            ...
            link = 'https://raw.githubusercontent.com/the13watchdogs/resources/master/tRmKGjTbr/xmls/watchdogs.xml'
