...
class Main:
    ...
    def __init__(self):
        ...
        xbmc.executebuiltin('SetProperty(boneinfo_running,True,home)')
        ...
        if self.infos:
            ...
            for key, value in iter(sorted(movie_items.iteritems())):
                ...
                li.setProperty('fanart_image', "special://home/addons/script.boneinfo/resources/skins/Default/media/%s-fanart.jpg" % image_code)
                if SCRIPT == "true" and "yt" not in value: url = 'plugin://script.boneinfo?info=%s&type=script' % key
                else: url = 'plugin://script.boneinfo?info=%s' % key
        ...
        xbmc.executebuiltin('ClearProperty(boneinfo_running,home)')
